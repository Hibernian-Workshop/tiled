...
class TileLayerEdit : public QObject
{
    ...
    Q_PROPERTY(bool undoable READ isUndoable WRITE setUndoable)
...
inline void TileLayerEdit::setUndoable(bool undoable)
{
    mUndoable = undoable;
}

inline bool TileLayerEdit::isUndoable() const
{
    return mUndoable;
}
